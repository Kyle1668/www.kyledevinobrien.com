...
# Opens all the current pages in browser

import os

os.system("/usr/bin/open -a \"/Applications/Google Chrome.app\" \'index.html\'")
os.system("/usr/bin/open -a \"/Applications/Google Chrome.app\" \'experience.html\'")
